...
function ProductList(props: any) {
  ...
  const sortProductList = useCallback(
    (productList: ProductForProductsPage[]): ProductForProductsPage[] => {
    ...
    [context.SortList.value]
  );

  const filterProductList = useCallback(
    (products: ProductForProductsPage[]): ProductForProductsPage[] => {
        ...
        function filterProductListBaseOnPriceRanges(
          ...
          return products.filter((product) => {
            return priceRanges.some((range) => {
              const minInRange =
                range.min === 'infinity' ? -Infinity : range.min;
              const maxInRange =
  ...
  const searchProductList = useCallback(
    (productList: ProductForProductsPage[], searchText: string) => {
